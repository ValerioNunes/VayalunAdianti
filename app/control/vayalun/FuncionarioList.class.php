...
/**
 * FuncionarioList short summary.
 *
 * FuncionarioList description.
 *
 * @version 1.0
 * @author valerio
 */
class FuncionarioList extends TStandardList
{
    ...
    public function __construct(){
        ...
        $this->form->setData( TSession::getValue('Funcionario') );
        
        // add the search form actions
        $btn = $this->form->addAction(_t('Find'), new TAction(array($this, 'onSearch')), 'fa:search');
        $btn->class = 'btn btn-sm btn-primary';
        $this->form->addAction(_t('New'),  new TAction(array('FuncionarioForm', 'onEdit')), 'bs:plus-sign green');
