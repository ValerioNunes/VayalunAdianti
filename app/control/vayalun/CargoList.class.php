...
/**
 * CargoList short summary.
 *
 * CargoList description.
 *
 * @version 1.0
 * @author valerio
 */
class CargoList extends TStandardList
{
    ...
    public function __construct(){
        ...
        parent::setActiveRecord('Cargo');   // defines the active record
        ...
        $this->form->setData( TSession::getValue('Cargo') );
